...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Circle Detail
    'circleDetail.loading': 'Loading...',
    'circleDetail.inviteMember': 'Invite Member',
    'circleDetail.inviteCopied': 'Invite link copied!',
    'circleDetail.members': 'Members',
    'circleDetail.campaigns': 'Campaigns',
    'circleDetail.games': 'Games',
    'circleDetail.rules': 'Circle Rules',
    'circleDetail.newCampaign': 'New Campaign',
    'circleDetail.noCampaigns': 'No campaigns yet',
    'circleDetail.createCampaign': 'Create New Campaign',
    'circleDetail.launchCampaign': 'Launch Campaign',
    'circleDetail.statusActive': 'Active',
    'circleDetail.statusCompleted': 'Completed',
    'circleDetail.statusDraft': 'Draft',
    'circleDetail.launchDate': 'Launch Date:',
    'circleDetail.tasks': 'tasks',
    'circleDetail.completed': 'completed',
    'circleDetail.readyForBundle': 'Ready to launch a bundle?',
    'circleDetail.bundleDesc': 'Promote all circle games together as one bundle',
    'circleDetail.launchBundle': 'Launch Circle Bundle',
  },
  ar: {
    // Navigation
    ...
    // Circle Detail
    'circleDetail.loading': 'جاري التحميل...',
    'circleDetail.inviteMember': 'دعوة عضو',
    'circleDetail.inviteCopied': 'تم نسخ رابط الدعوة!',
    'circleDetail.members': 'الأعضاء',
    'circleDetail.campaigns': 'الحملات',
    'circleDetail.games': 'الألعاب',
    'circleDetail.rules': 'قواعد الدائرة',
    'circleDetail.newCampaign': 'حملة جديدة',
    'circleDetail.noCampaigns': 'لا توجد حملات حتى الآن',
    'circleDetail.createCampaign': 'إنشاء حملة جديدة',
    'circleDetail.launchCampaign': 'حملة إطلاق',
    'circleDetail.statusActive': 'نشطة',
    'circleDetail.statusCompleted': 'مكتملة',
    'circleDetail.statusDraft': 'مسودة',
    'circleDetail.launchDate': 'تاريخ الإطلاق:',
    'circleDetail.tasks': 'مهمة',
    'circleDetail.completed': 'مكتملة',
    'circleDetail.readyForBundle': 'جاهز لإطلاق حزمة؟',
    'circleDetail.bundleDesc': 'ارفع جميع ألعاب الدائرة معاً كحزمة واحدة',
    'circleDetail.launchBundle': 'إطلاق حزمة الدائرة',
  },
};
